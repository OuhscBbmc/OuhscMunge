...
test_that("clump_week_date -typical", {
  ...
  expected <- structure(c(
    15082, 15082, 15082, 15089, 15089, 15089, 15089, 
    15089, 15089, 15089, 15096, 15096, 15096, 15096, 15096, 15096, 
    15096, 15103, 15103, 15103, 15103, 15103, 15103, 15103
  ), class = "Date")
  observed <- OuhscMunge::clump_week_date(detailed)#; dput(observed)
