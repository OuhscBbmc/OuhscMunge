...
test_that("trim_date -good", {
  ...
  expected_1  <-as.Date(c(NA_character_, "1999-09-09", "2020-02-22", "2030-01-01", NA_character_))
  expected_2  <-as.Date(c("1977-07-27", "1999-09-09", "2020-02-22", "2030-01-01", "1977-07-27"))
