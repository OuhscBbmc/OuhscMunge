...
#' @param class_vector The required [base::class()] of the vector.  If the
#' parameter is missing, the object's class is not checked.
#' @param proportion_minimum The (inclusive) minimum proportion of the
#' vector's elements that should meet the requirement. If missing, all
#' elements must pass.
#'
#' @examples
