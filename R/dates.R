...
#' 
#' @param date_detailed The \code{Date} value containing the desired year and month.  The day will be overwritten. Required
#' @param day_of_month The factor label assigned to the missing value.  Defaults to \code{15}.
#' @return An array of \code{Date} values.
#' 
#' @details 
...
#' 
#' @note
#' A \code{stop} error will be thrown if \code{date_detailed} is not a \code{Date}, or if \code{day_of_month} is not bounded by \code{[1, 31]}.
